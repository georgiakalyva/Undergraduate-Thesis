...
namespace ThesisWebApplication.API
{
    public class ExercisesController : ApiController
    {
        ...
        // GET: api/Exercises
        public IEnumerable<JExercise> GetExercises()
        {
            IEnumerable<JExercise> Exersices = (from ex in db.Exercises
                                                select new JExercise()
                                                {
                                                    ID = ex.ID,
